/*
  ...
  1. Changes
    - Remove toy_id from rentals table (it's now in rental_items)
    - Add proper validation for rental items
    - Fix transaction handling
*/

-- Remove toy_id from rentals as it's now in rental_items
ALTER TABLE rentals DROP COLUMN IF EXISTS toy_id;

-- Create new function with proper item handling
