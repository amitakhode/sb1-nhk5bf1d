/*
  # Fix Create Order Function

  1. Changes
    - Drop all existing versions of create_order function
    - Create single, correct version with proper parameter handling
    - Fix parameter name inconsistency (toyId vs toy_id)
...
-- Create new function with proper validation and consistent naming
...
BEGIN
  ...
  BEGIN
    ...
    LOOP
      ...
      BEGIN
        -- Use toyId from client-side JSON
